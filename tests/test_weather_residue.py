...
def test_live_readout_renders_transition_instead_of_replacing_current_atmosphere():
    core = {"charge": 0.8, "clutch": 0.1, "strain": 0.05}
    route = {
    ...
    texture = atmosphere_texture(core, route)
    atmosphere = {
        "core": {"charge": 0.45, "clutch": 0.5, "strain": 0.2},
        "route": route,
        "texture": texture,
        "readout": {"warmth": 0.7, "shadow": 0.1},
        "climate": {
            "current": "Banked Heat",
            "candidate": "Banked Heat",
            "candidate_steps": 0,
            "blend": 0.0,
            "current_score": 0.4,
        },
